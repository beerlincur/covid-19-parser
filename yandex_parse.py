...
def yandex_parser():
    ...
    try:
        base_url = "https://yandex.ru/maps/covid19?ll=46.737291%2C44.867346&z=2.63" # url
        ...
        if request.status_code == 200: # если страница получена:
            ...
            cities_divs = soup.find_all("div", attrs={'class': "covid-panel-view__item-name"}) # поиск городов

            cases_divs = soup.find_all("div", attrs={'class': "covid-panel-view__item-cases"}) # поиск чисел по городам
            ...
            values_divs = soup.find_all('div', attrs={'class': "covid-panel-view__stat-item-value"}) # поиск статистических данных

            titles_divs = soup.find_all('div', attrs={'class': "covid-panel-view__stat-item-title"}) # поиск заголовков
